...
public class ZaraTest extends BaseTest {
    ...
    public void testZaraShoppingFlow() throws InterruptedException {
        ...
        // 7. Sepetteki fiyat ile ürün sayfasındaki fiyat karşılaştırılır
        String cartPrice = cartPage.getCartPrice();
        assertEquals(selectedProduct.price, cartPrice, "Sepetteki fiyat ürün sayfasıyla uyuşmuyor!");

        // 8. Adet artırılır ve adetin 2 olduğu doğrulanır
        cartPage.increaseQuantityToTwo();
        Thread.sleep(2000); // artış işlemi sonrası bekleme
        assertTrue(cartPage.isQuantityTwo(), "Ürün adedi 2 değil!");

        // 9. Ürün silinir ve sepetin boş olduğu doğrulanır
        cartPage.deleteProduct();
        Thread.sleep(2000); // silme işlemi sonrası bekleme
